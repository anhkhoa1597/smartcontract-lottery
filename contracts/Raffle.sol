...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    /* State Variables */
    uint256 private immutable i_entranceFee; //immutable variable phí tham gia
    address payable[] private s_players; // Danh sách các địa chỉ ví tham gia
    ...
    /**
     * @dev Chainlink VRF node calls this function to send the money to random winner
     */
